...
#ifdef _DEBUG_
    rtx_dbug_outs((CHAR*)"Kernel process at time: " );
    WriteNumber( tValue * 10 );
    rtx_dbug_outs( (CHAR*)" us" );
    WriteLine();
#endif

    // Reset tValue and disable timer interrupt
    tValue = 0;
    TIMER0_TMR = 0x1319;
	//TIMER0_TCN = 0;
